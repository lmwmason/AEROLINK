...
#if defined(USE_AEROLINK) && ENABLE_SIMULATOR
    [TASK_AEROLINK] = DEFINE_TASK("AEROLINK", NULL, NULL, aerolinkSitlTask, TASK_PERIOD_HZ(200), TASK_PRIORITY_LOW),
#endif
...
#if defined(USE_AEROLINK) && ENABLE_SIMULATOR
    setTaskEnabled(TASK_AEROLINK, targetGetAerolinkVehicleId() != 0);
#endif
